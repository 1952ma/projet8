...
class TestModelTraining(unittest.TestCase):
    def setUp(self):
        ...
        self.model_path = os.path.join(current_directory, "..", "dashboard", "backend", "model.joblib")
    ...
    def test_model_prediction(self):
        ...
        current_directory = os.path.dirname(os.path.realpath(__file__))
        X_sample = pd.read_csv(os.path.join(current_directory, "..", "dashboard", "backend", "df_nouveaux_clients.csv")).drop(columns=["SK_ID_CURR"])
